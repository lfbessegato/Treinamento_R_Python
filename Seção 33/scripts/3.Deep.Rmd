...
#uso interno
options(warn=-1)
digitos <- read.csv(gzfile("/home/luciano/github/Treinamento_R_Python/Seção 33/dados/test.csv.gz"), header=F)
dim(digitos)
head(digitos)
```
...
```{r}
h2o.init()
treino <- h2o.importFile('/home/luciano/github/Treinamento_R_Python/Seção 33/dados/train.csv.gz')
teste <- h2o.importFile('/home/luciano/github/Treinamento_R_Python/Seção 33/dados/test.csv.gz')
dim(treino)
head(treino)
colnames(treino)
