...
Carga de dados
```{r}
eleicao = read.csv("/home/luciano/GitHub/Treinamento_R_Python/Seção 24/dados/Eleicao.csv",sep=';',header=T)
eleicao
```
...
Novos candidatos
```{r}
prevereleicao = read.csv("/home/luciano/GitHub/Treinamento_R_Python/Seção 24/dados/NovosCandidatos.csv",sep=';',header=T)
prevereleicao
```
Previsão
```{r}
