---
title: "Formação de Cientista de Dados"
output: Luciano Bessegato
---
...
```
```{r}
dados = read.csv("D://github//Cientista R e Python//Seção 12//dados//dados.csv", sep=";")
head(dados)
```
```{r}
...
hist(dados$PIB, main="Valores do PIB", col=brewer.pal(n = 3, name = "Pastel1"), outline = F)
```
```{r}
